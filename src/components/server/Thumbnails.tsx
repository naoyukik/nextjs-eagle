...
const Thumbnails = async (props: DashboardHomeProps) => {
  ...
  if (props.searchParams && typeof props.searchParams.folder !== 'undefined') queryParams.push(`folders=${props.searchParams.folder}`)
  console.log(queryParams)
